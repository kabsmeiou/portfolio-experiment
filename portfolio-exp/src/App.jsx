...
function HeaderNavigation({navigateTo}) {
    return (
        <>
        <div className='text-lg text-white font-bold text-glow'>
            {navigateTo}
        </div>
        </>
    );
  ...
  return (
    <>
      <div className='flex gap-x-12 justify-center items-center custom-header w-full' style={{backgroundColor: '#171717'}}>
        <HeaderNavigation navigateTo='Home'/>
        <HeaderNavigation navigateTo='About Me'/>
        <HeaderNavigation navigateTo='Portfolio'/>
      {/* <Particles
            id="tsparticles"
            init={particlesInit}
      ...
      <div className='w-full h-screen overflow-hidden' style={{backgroundColor: '#EDEDED'}}>
        <div className='flex flex-1 mt-12'>
            <div className='flex h-screen w-6/12 items-center justify-center'>
                <div className='relative h-36r w-36r resize-effect'>
                    <div className='relative h-90p w-90p' style={{backgroundColor: '#171717'}}>
                    
                    </div>
                    <div className='absolute bottom-0 right-0 h-90p w-90p bg-temp-image bg-center bg-cover'>
            ...
            <div className='flex w-6/12 items-center justify-center overflow-hidden'>
                <div className='h-fit me-2'>
                    ...
                    <div className='text-xl font-bold w-fit text-shadow-lg'>Click here to continue &raquo;</div>
                </div>
            </div>
        </div>
      </div>
